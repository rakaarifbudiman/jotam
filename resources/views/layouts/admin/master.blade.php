...
<body>
    <div class="preloader">
        ...
        <div class="loading">
            <div class="loader-box">
                <div class="loader-15 font-primary"></div>
            </div>
            <h5 class="text-center font-primary">
                Please Wait...</h5>
        </div>
    </div>
    @php
        $loginusers = App\Models\Session::whereNotNull('user_id')->where('user_id','<>',Auth()->user()->id)->orderBy('last_activity','desc')->get();
    @endphp
    <!-- page-wrapper Start-->
    ...
    <footer style="margin:0px !important;padding: 0px !important; height:20px">
        Copyright
           ...
           {{ config('app.version') }} All rights reserved. <a class="text-primary"
               href="https://saweria.co/rakaarif" target="_blank">Support Admin</a>
   </footer>
</body>
